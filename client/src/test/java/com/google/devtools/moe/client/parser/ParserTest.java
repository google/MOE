  ...
  public void testParseExpression() throws Exception {
    ...
    testParseExHelper(
        ...
        new RepositoryExpression("internal")
            .withOption("revision", "1").editWith("editor", ImmutableMap.of("locale", "en_US")));

    testParseExHelper(
        "internal(revision=1)|editor(locale=\"en_US\")>public",
        new RepositoryExpression(new Term("internal", ImmutableMap.of("revision", "1")))
            .editWith("editor", ImmutableMap.of("locale", "en_US")).translateTo("public"));
  }
  ...
  public void testParseRepositoryExpression() throws Exception {
    ...
    testParseRepoExHelper(
        ...
        new RepositoryExpression("file")
            .withOption("path", "/tmp").withOption("projectSpace", "internal"));
