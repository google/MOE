...
public class EvaluatorTest extends TestCase {
  ...
  public void testParseAndEvaluate() throws Exception {
    ...
    expect(translatorEditor.edit(firstDir, ImmutableMap.<String, String>of())).andReturn(secondDir);
    expect(e.getDescription()).andReturn("");
    expect(e.edit(secondDir, ImmutableMap.<String, String>of())).andReturn(finalDir);
